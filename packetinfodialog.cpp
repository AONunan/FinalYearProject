...
PacketInfoDialog::PacketInfoDialog(const Packet packet, QWidget *parent) :
    ...
    ui->label_src_host->setText("");
    ui->label_dst_host->setText("");
    ui->label_src_port->setText(QString::number(packet.getTcp_source_port()));
    ui->label_dst_port->setText(QString::number(packet.getTcp_destination_port()));
